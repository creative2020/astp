        ...
        $plugins = array(
			...
			"wp-database-optimizer/wp_database_optimizer.php",
                ...
                foreach ( $plugins as $plugin ) 
                {
                        ...
                        {
                                echo '<div class="error"><p>The plugin <strong>'.$plugin.'</strong> is not allowed and will not remain activated. We recommend deleting it.</p></div>';
                        }
                }
