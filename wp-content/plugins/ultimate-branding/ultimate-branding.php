...
'http://updates.wppronto.com/wp-update-server/?action=get_metadata&slug=ultimate-branding', //Metadata URL.
__FILE__, //Full path to the main plugin file.
'ultimate-branding' //Plugin slug. Usually it's the same as the name of the directory.
);
